...
<template>
  <div class="grid items-center grid-cols-2">
    <div class="flex pb-2 self-center">
      <img src="../assets/title_star.svg" alt="Your secret counter app">
  ...
  <div v-if="show">
    <div class="grid grid-cols-3 w-full justify-items-center mt-12 mb-16">
      ...
      <button class="cols-start-3 w-max bg-box-yellow h-max self-center px-9 py-4 font-semibold rounded-md text-2xl ml-4"> + </button>
    </div>

    <div class="grid w-full justify-items-center mb-16">
      <button class="font-semibold text-[#4E4B66] dark:text-white border-2 border-[#4E4B66] dark:border-white px-8 py-3 rounded-md">Reset Counter?</button>
    </div>
  </div>
</template>